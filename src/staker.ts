...
import IIntrinsicStaker from '@intrinsic-network/staker/artifacts/contracts/IntrinsicStaker.sol/IntrinsicStaker.json'
...
export abstract class Staker {
  public static INTERFACE: Interface = new Interface(IIntrinsicStaker.abi)
